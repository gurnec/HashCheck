...
Name "HashCheck"
OutFile "HashCheckSetup-v2.4.1.53-alpha.exe"
...
VIProductVersion "2.4.1.53-alpha"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "HashCheck Shell Extension"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "2.4.1.53-alpha"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "2.4.1.53-alpha"
