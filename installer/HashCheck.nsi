...
Name "HashCheck"
OutFile "HashCheckSetup-v2.4.0.41-beta.exe"
...
VIProductVersion "2.4.0.41-beta"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "HashCheck Shell Extension"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "2.4.0.41-beta"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "2.4.0.41-beta"
